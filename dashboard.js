...
document.addEventListener('click', function(event) {
    ...
    function openEditModal(button) {
        // Get tour data from button's data attributes
        var id = button.getAttribute('data-id');
        var tourType = button.getAttribute('data-tourtype');
        var priceAdult = button.getAttribute('data-priceadult');
        var priceKid = button.getAttribute('data-pricekid');
        var inclusion = button.getAttribute('data-inclusion');
        var exclusion = button.getAttribute('data-exclusion');
        
        // Set values in the modal's form
        document.getElementById('tourId').value = id;
        document.getElementById('tourType').value = tourType;
        document.getElementById('priceAdult').value = priceAdult;
        document.getElementById('priceKid').value = priceKid;
        document.getElementById('inclusion').value = inclusion;
        document.getElementById('exclusion').value = exclusion;
